...
public final class SliderLayoutBinding implements ViewBinding {
  ...
  private SliderLayoutBinding(@NonNull LinearLayout rootView, @NonNull TextView texttitle,
      @NonNull ImageView titleImage) {
  ...
  public static SliderLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new SliderLayoutBinding((LinearLayout) rootView, texttitle, titleImage);
    }
